...
public class P4Wrapper {
	...
	public static class SinglyLinkedList<E> implements List<E> {
		...
		// node class for sortedlisttobst
	...
	/*
	 * Write a non-member method named sortedListToBST. Given a singly linked list
	 * where elements are sorted in ascending order, convert it to a height balanced
	 * Binary Search Tree BST. The method receives as parameter a non-empty list
	 * with integers sorted in increasing (ascending) order. Note: The tester will
	 * use BST method isBalanced() (see above) to check if the tree is balanced.
	 *
	 * Hint 1: Recall binary search on an array of integers.
	 *
	 * Hint 2: Write an auxiliary function that moves over the singly-linked list as
	 * if doing a binary search: split the list in halves and always put in the BST
	 * the element in the midpoint of the list segment being processed. Divide and
	 * Conquer.
	 *
	 */
	public static BinarySearchTree<Integer, Integer> sortedListToBST(SinglyLinkedList<Integer> L) {
		Integer n = L.size() / 2;
		return sortedListToBSTAux(L, n);
	}

	public static BinarySearchTree<Integer, Integer> sortedListToBSTAux(SinglyLinkedList<Integer> L, int n) {
