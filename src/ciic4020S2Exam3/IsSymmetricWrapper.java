...
public class IsSymmetricWrapper {
	...
	public static class SimpleBinaryTreeImp<E> implements SimpleBinaryTree<E> {
		...
		/*
		 * A Binary Tree is symmetric if for every internal node: a) the value at the
		 * left child is equal to the value at the right child b) the subtree rooted at
		 * the left child is symmetric b) the subtree rooted at the right child is
		 * symmetric.
		 *
